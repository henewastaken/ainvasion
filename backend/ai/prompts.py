...
# Placeholders are filled with str.format(**kwargs) before sending.
...
Items can have what ever effect you want.
...
Attack type: {attack_type}  (war = military invasion | diplomatic = peaceful alliance attempt)
...
Respond ONLY in valid JSON, NOT a single word, and nothing else. The JSON format i:
{{
...
Resources used to aid research: {resources_used}
